...
> **v1.2.0** — Android app, backend, and dashboard work end to end, with TLS,
> rate limiting, local retention, admin/read-only roles, and single-use device
> enrolment. 1.1 added webhooks and CSV/JSON export; 1.2 adds a sync pause
> switch on the phone and a durable audit trail on the server. See
